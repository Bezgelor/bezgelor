  ...
  def auth(assigns) do
    ...
    <div class="gaming-bg min-h-screen flex flex-col">
      ...
      <nav class="relative z-10 p-4">
        <a href="/" class="inline-flex items-center gap-2 text-white/70 hover:text-[var(--gaming-cyan)] transition-colors">
        ...
        <div class="w-full max-w-md">
          ...
          <div class="text-center mt-6 space-y-3">
            <div class="flex items-center justify-center gap-4 text-sm">
              ...
              <a href="/privacy" class="text-white/50 hover:text-[var(--gaming-cyan)] transition-colors">
                Privacy
              </a>
              <span class="text-white/30">•</span>
              <a href="https://discord.gg/bezgelor" target="_blank" class="text-white/50 hover:text-[var(--gaming-cyan)] transition-colors">
                Support
              </a>
            </div>
          </div>
    ...
    <div id="mobile-menu" class="hidden fixed inset-0 z-50 bg-[var(--gaming-bg-dark)] md:hidden">
      <div class="flex flex-col h-full p-6">
        ...
        <div class="flex flex-col gap-4">
          ...
          <a href="/community" class="text-xl text-white hover:text-[var(--gaming-cyan)]">Community</a>
