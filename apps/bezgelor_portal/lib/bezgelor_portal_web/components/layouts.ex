defmodule BezgelorPortalWeb.Layouts do
    ...
    <!-- Footer links -->
          <div class="text-center mt-6 space-y-3">
            <div class="flex items-center justify-center gap-4 text-sm">
              ...
              <span class="text-white/30">•</span>
              <a
                href="https://discord.gg/HfWATTNQnk"
                target="_blank"
                class="text-white/50 hover:text-[var(--gaming-cyan)] transition-colors"
              >
                Support
  ...
  def gaming_footer(assigns) do
    ...
    <!-- Community Section -->
        <div class="footer-gaming-section">
          <h4>Community</h4>
          <a href="https://discord.gg/HfWATTNQnk" target="_blank" rel="noopener">
    ...
    <!-- Support Section -->
      ...
      <div class="footer-gaming-bottom">
        ...
        <div class="footer-gaming-social">
          <a href="https://discord.gg/HfWATTNQnk" target="_blank" rel="noopener" aria-label="Discord">
