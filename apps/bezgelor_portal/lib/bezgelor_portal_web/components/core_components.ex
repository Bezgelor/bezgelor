defmodule BezgelorPortalWeb.CoreComponents do
  @moduledoc """
  ...
  def modal(assigns) do
    ...
    >
      ...
      <form method="dialog" class="modal-backdrop">
        <button phx-click={@on_cancel |> hide_modal(@id)}>close</button>
      </form>
    </dialog>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BezgelorPortalWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BezgelorPortalWeb.Gettext, "errors", msg, opts)
    end
  end
