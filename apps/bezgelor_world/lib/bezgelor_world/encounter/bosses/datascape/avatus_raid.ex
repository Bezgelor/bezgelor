  ...
  boss "Avatus" do
    ...
    phase :two, health_between: {50, 75} do
      ...
      ability :data_fragment, cooldown: 40_000, target: :random do
        ...
        coordination(:stack, min_players: 8, damage: 200_000)
      end
    ...
    phase :four, health_below: 25 do
      ...
      ability :delete_all, cooldown: 60_000 do
        ...
        coordination(:soak, base_damage: 300_000, required_players: 20)
      end

      ability :final_calculation, cooldown: 90_000 do
        telegraph(:room_wide, duration: 8000)
        damage(150_000, type: :magic)
      end
      ...
      ability :existence_erasure, cooldown: 28_000, target: :random do
        ...
        coordination(:spread, min_distance: 15, damage: 100_000)
      end
    ...
    on_death do
      ...
      # Datascape complete
      achievement(7009)
      # Realm First: Avatus (conditional)
      achievement(7100)
    end
  end
end
